...
namespace backend.Migrations
{
    ...
    [Migration("20201028205116_fix-to-finalDB1")]
    partial class fixtofinalDB1
    {
       ...
       <tr>
         ...
         <td valign='top' class='col-2'>
           <table cellspacing='0' cellpadding='0' width='100%'>
                     ...
                     <td>
                       ...
                       <table cellspacing='0' cellpadding='0' width='100%'>
 						...
 						<br>
                            ...
                            email_type = "PaymentConfirmation"
                        });
                });
            ...
            modelBuilder.Entity("backend.DataAccess.Database.Entities.ProjectEntity", b =>
                {
                    b.Property<int>("id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("backend.DataAccess.Database.Entities.ProjectExpenditure", b =>
                {
                    b.Property<int>("id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<double>("target_cost")
                        .HasColumnType("double");

                    b.HasKey("id");

                    b.ToTable("project_expenditure");
                });

            modelBuilder.Entity("backend.DataAccess.Database.Entities.ProjectProgress", b =>
                {
                    b.Property<int>("id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("current_quarter")
                        .HasColumnType("longtext CHARACTER SET utf8mb4");
                    ...
                    b.Property<double>("project_status_percentage")
                        .HasColumnType("double");

                    b.Property<string>("start_quarter")
                        .HasColumnType("longtext CHARACTER SET utf8mb4");

                    b.Property<int>("target_duration")
                        .HasColumnType("int");

                    b.Property<string>("target_end_quarter")
                        .HasColumnType("longtext CHARACTER SET utf8mb4");

                    b.Property<DateTime>("target_start_date")
                        .HasColumnType("datetime(6)");
            ...
            modelBuilder.Entity("backend.DataAccess.Database.Entities.ProjectTODO", b =>
                {
                    b.Property<int>("id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("backend.DataAccess.Database.Entities.SPGetAllProjectEntity", b =>
                {
                    b.Property<string>("company_registration")
                        .HasColumnType("longtext CHARACTER SET utf8mb4");
                    ...
                    b.Property<double>("pe_actualCost")
                        .HasColumnType("double");

                    b.Property<string>("pe_focusArea")
                        .HasColumnType("longtext CHARACTER SET utf8mb4");

                    b.Property<int>("pe_id")
                        .HasColumnType("int");

                    b.Property<string>("pe_item")
                        .HasColumnType("longtext CHARACTER SET utf8mb4");

                    b.Property<double>("pe_targetCost")
                        .HasColumnType("double");

                    b.Property<string>("pg_StartQuarter")
                        .HasColumnType("longtext CHARACTER SET utf8mb4");

                    b.Property<DateTime>("pg_actualEndDate")
                        .HasColumnType("datetime(6)");

                    b.Property<DateTime>("pg_actualStartDate")
                        .HasColumnType("datetime(6)");

                    b.Property<string>("pg_currentQuarter")
                        .HasColumnType("longtext CHARACTER SET utf8mb4");

                    b.Property<int>("pg_id")
                        .HasColumnType("int");

                    b.Property<string>("pg_projectStatus")
                        .HasColumnType("longtext CHARACTER SET utf8mb4");

                    b.Property<double>("pg_projectStatusPercentage")
                        .HasColumnType("double");

                    b.Property<int>("pg_targetDuration")
                        .HasColumnType("int");

                    b.Property<string>("pg_targetEndQuarter")
                        .HasColumnType("longtext CHARACTER SET utf8mb4");

                    b.Property<DateTime>("pg_targetStartDate")
                        .HasColumnType("datetime(6)");

                    b.Property<DateTime>("project_createdOn")
                        .HasColumnType("datetime(6)");
                    ...
                    b.Property<DateTime>("pt_dateEnded")
                        .HasColumnType("datetime(6)");

                    b.Property<DateTime>("pt_dateStarted")
                        .HasColumnType("datetime(6)");

                    b.Property<string>("pt_focusArea")
                        .HasColumnType("longtext CHARACTER SET utf8mb4");

                    b.Property<int>("pt_id")
                        .HasColumnType("int");

                    b.Property<bool>("pt_isSequential")
                        .HasColumnType("tinyint(1)");

                    b.Property<string>("pt_item")
                        .HasColumnType("longtext CHARACTER SET utf8mb4");

                    b.Property<int>("pt_sequence")
                        .HasColumnType("int");

                    b.ToTable("sPGetAllProjects");
                });
            ...
            modelBuilder.Entity("backend.DataAccess.Database.Entities.TargetSettingsEntity", b =>
                {
                    ...
                    b.Property<double>("q1_actual")
                        .HasColumnType("double");

                    b.Property<double>("q1_target")
                        .HasColumnType("double");

                    b.Property<double>("q2_actual")
                        .HasColumnType("double");

                    b.Property<double>("q2_target")
                        .HasColumnType("double");

                    b.Property<double>("q3_actual")
                        .HasColumnType("double");

                    b.Property<double>("q3_target")
                        .HasColumnType("double");

                    b.Property<double>("q4_actual")
                        .HasColumnType("double");
